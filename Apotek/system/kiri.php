...
if ($_GET[module]=='home'){
	...
	<span style='float:right'><a href='media.php?module=home&grafik=kategori'></a></h3>";
...
elseif ($_GET[module]=='faktur'){
	...
	echo "<input type=button value='Buat Faktur Obat Baru' onclick=\"window.location.href='media.php?module=tambahfaktur';\">
	<table class='data'>
			<tr class='data'>
...
elseif ($_GET[module]=='keranjangbelanja'){
  ...
  echo "<h3>Halaman untuk Transaksi</h3><br>
			 <div class='h_line'></div>"; 
...
$edit = mysql_query("SELECT * FROM orders WHERE id_orders='$_GET[id]'");
    ...
    echo "<h3>Detail Data Pesanan</h3><br>
          <table width=100%>
